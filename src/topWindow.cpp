                                                     ...
                                                     application(app)
{
     ...
     **/
    addMenuItem(menu.get(), "whatis.menu",     "whatis.body",     "");
    addMenuItem(menu.get(), "devplan.menu",    "devplan.body",    "devplan");
    addMenuItem(menu.get(), "improve.menu",    "improve.body",    "improve");
    addMenuItem(menu.get(), "contact.menu",    "contact.body",    "contact");
    addMenuItem(menu.get(), "whysponsor.menu", "whysponsor.body", "whysponsor");
    addMenuItem(menu.get(), "sponsornow.menu", "sponsornow.body", "sponsornow");
    addMenuItem(menu.get(), "news.menu",       "news.body",       "news");
